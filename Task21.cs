namespace Task21
{
    //ЗАДАЧА 21: на входе координаты двух точек в трехмерном пространстве, на выходе расстояние между ними.
    public class DZ
    {
        public void Start() // === START ===
        {
            ...
            Console.WriteLine("ЗАДАЧА 21: на входе координаты двух точек в трехмерном пространстве, на выходе расстояние между ними.");
            Console.ResetColor();
        ...
        List<double[]> InputСoord(int allSpace)
        {
            ...
            Input:
                ...
                str = Console.ReadLine()!.Trim(); // ввод координат
                ...
                {                    
                    ...
                    if (double.TryParse(str_[j], out double a) == true) // если координата является числом типа Double
                    {
    ...
    //На случай запуска Task21.cs как самостоятельно проекта, не из под Главного Меню
    class Program
    {
        static void Main()
        {
